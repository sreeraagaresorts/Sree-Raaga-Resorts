  ...
  return (
    <div className="space-y-8 text-[#0d2b4e]">
      ...
      <div className="border-t border-[#0d2b4e]/10 pt-6">
        <h3 className="text-2xl font-corm font-light tracking-wide mb-4 text-[#0d2b4e]">Room Bookings</h3>
      ...
      <div className="border-t border-[#0d2b4e]/10 pt-6">
        <h3 className="text-2xl font-corm font-light tracking-wide mb-4 text-[#0d2b4e]">Day Out Packages</h3>
        <ul className="list-disc pl-6 space-y-2 text-[#2d5b8a] font-jost font-light text-[15px]">
          <li>All cancellations are non-refundable.</li>
        </ul>
      </div>
      ...
      <div className="border-t border-[#0d2b4e]/10 pt-6">
        <h3 className="text-2xl font-corm font-light tracking-wide mb-4 text-[#0d2b4e]">Event & Banquet Bookings</h3>
        <ul className="list-disc pl-6 space-y-2 text-[#2d5b8a] font-jost font-light text-[15px]">
      ...
      <div className="border-t border-[#0d2b4e]/10 pt-6">
        <h3 className="text-2xl font-corm font-light tracking-wide mb-4 text-[#0d2b4e]">Refund Processing</h3>
        <ul className="list-disc pl-6 space-y-2 text-[#2d5b8a] font-jost font-light text-[15px]">
      ...
      <div className="border-t border-[#0d2b4e]/10 pt-6">
        <h3 className="text-2xl font-corm font-light tracking-wide mb-4 text-[#0d2b4e]">Force Majeure</h3>
        <ul className="list-disc pl-6 space-y-2 text-[#2d5b8a] font-jost font-light text-[15px]">
