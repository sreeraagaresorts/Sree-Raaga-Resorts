...
const UserSettings = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 text-[#0d2b4e]">
      <h1 className="text-3xl  font-medium mb-6 text-[#0d2b4e] border-b border-gray-200/50 pb-3">Account Settings</h1>
            ...
            <form onSubmit={handlePasswordChange} className="space-y-4 text-xs font-light">
              ...
              <div className="pt-2">
                <button 
                  ...
                  className="bg-[#c8a64d] text-white px-6 py-4 rounded-none font-semibold uppercase tracking-widest text-[14px] hover:bg-[#b09141] transition cursor-pointer shadow-sm flex items-center gap-2 disabled:bg-[#c8a64d]/60"
                >
                  {updatingPassword ? (
                    <>
