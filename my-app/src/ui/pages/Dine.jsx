    ...
    <>
      ...
      <div className="bg-[#fcfaf2] text-[#0d2b4e] font-serif min-h-screen">
        ...
        <section className="py-20 max-w-4xl mx-auto px-6 text-center select-none">
          <span className="text-[#c8a64d] uppercase tracking-[4px] mb-4 text-xs font-semibold font-sans block">
            Culinary Delights
          </span>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-8 md:gap-16 pt-6 border-t border-[#0d2b4e]/10 max-w-lg mx-auto font-sans text-xs uppercase tracking-wider text-gray-500 font-semibold">
        ...
        <section className="py-12  pb-28 space-y-24 md:space-y-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="space-y-6">
              <span className="text-[#c8a64d] uppercase tracking-[4px] text-xs font-semibold font-sans block">
                Restaurant
              </span>
              <h3 className="text-3xl font-light text-[#0d2b4e]">
                Multi-Cuisine Dining
              </h3>
              <p className="text-gray-500 text-sm md:text-base leading-relaxed font-sans font-light">
              ...
              <div className="pt-2">
                <Link 
                  to="/menu"
                  className="inline-block border border-[#0d2b4e] px-8 py-3 text-[#0d2b4e] hover:bg-[#0d2b4e] hover:text-white uppercase tracking-widest text-xs font-bold font-sans transition duration-300"
                >
                  Explore Menu
                </Link>
              </div>
