...
const Payments = () => {
  return (
    <div className="space-y-6">
      ...
      <h3 className="text-xl font-serif text-[#0d2b4e] mt-8 mb-4">Financial Privacy Protection</h3>
      ...
      <h3 className="text-xl font-serif text-[#0d2b4e] mt-8 mb-4">Account Integrity</h3>
