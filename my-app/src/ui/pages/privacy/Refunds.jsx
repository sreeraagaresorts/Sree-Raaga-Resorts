...
const Refunds = () => {
  return (
    <div className="space-y-6">
      ...
      <h3 className="text-xl font-serif text-[#0d2b4e] mt-8 mb-4">Room Cancellation & Refunds</h3>
      ...
      <h3 className="text-xl font-serif text-[#0d2b4e] mt-8 mb-4">Service & Food Refund Policy</h3>
