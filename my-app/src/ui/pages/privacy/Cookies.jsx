  ...
  return (
    <div className="space-y-8 text-[#0d2b4e]">
      ...
      <div className="border-t border-[#0d2b4e]/10 pt-6">
        <h3 className="text-2xl  font-corm font-medium tracking-wide mb-4 text-[#0d2b4e]">What Are Cookies?</h3>
        <p className="text-[#2d5b8a] font-jost font-medium text-[17px] leading-relaxed">
      ...
      <div className="border-t border-[#0d2b4e]/10 pt-6">
        <h3 className="text-2xl  font-corm font-medium tracking-wide mb-4 text-[#0d2b4e]">How We Use Cookies</h3>
      ...
      <div className="border-t border-[#0d2b4e]/10 pt-6">
        <h3 className="text-2xl  font-corm font-medium tracking-wide mb-4 text-[#0d2b4e]">Third-Party Cookies</h3>
        <p className="text-[#2d5b8a] font-jost font-medium text-[17px] leading-relaxed">
      ...
      <div className="border-t border-[#0d2b4e]/10 pt-6">
        <h3 className="text-2xl  font-corm font-medium tracking-wide mb-4 text-[#0d2b4e]">Managing Cookies</h3>
        <p className="text-[#2d5b8a] font-jost font-medium text-[17px] leading-relaxed">
