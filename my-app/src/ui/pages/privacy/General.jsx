  ...
  return (
    <div className="space-y-8 text-[#0d2b4e]">
      ...
      <div className="border-t border-[#0d2b4e]/10 pt-6">
        <h3 className="text-2xl  font-corm font-medium tracking-wide mb-4 text-[#0d2b4e]">Information We Collect</h3>
      ...
      <div className="border-t border-[#0d2b4e]/10 pt-6">
        <h3 className="text-2xl  font-corm font-medium tracking-wide mb-4 text-[#0d2b4e]">How We Use Your Information</h3>
        <p className="text-[#2d5b8a] font-jost font-medium text-[17px] mb-4 leading-relaxed">
      ...
      <div className="border-t border-[#0d2b4e]/10 pt-6">
        <h3 className="text-2xl  font-corm font-medium tracking-wide mb-4 text-[#0d2b4e]">Information Sharing</h3>
        <p className="text-[#2d5b8a] font-jost font-medium text-[17px] mb-4 leading-relaxed">
