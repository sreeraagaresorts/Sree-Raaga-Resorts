        ...
        {confirmModal.isOpen && (
          <div className="fixed inset-0 bg-black/85 backdrop-blur-sm flex items-center justify-center z-[10000] p-4">
            <motion.div 
              ...
              className={`bg-[#081a2f]/95 backdrop-blur-lg rounded-2xl p-8 max-w-md w-full text-center space-y-5 relative ${
                confirmModal.type === "destructive" 
                  ? "border border-red-500/25 shadow-[0_20px_50px_rgba(239,68,68,0.15)]" 
